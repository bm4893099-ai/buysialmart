  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950/80">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div>
          <LogoMark />
          <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300">{t('footer.description')}</p>
        </div>

        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-200">Explore</h3>
